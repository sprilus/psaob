...
public class PsaobTestContainer extends TestContainer {

    public PsaobTestContainer() {
        super();
    ...
    public static class Common extends PsaobTestContainer {

        public static final PsaobTestContainer.Common INSTANCE = new PsaobTestContainer.Common();
